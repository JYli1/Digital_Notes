...
![[file-20251212232639539.png]]

2. 用&也没有传入两对


![[file-20251212232639538.png]]

3. 当我们用"+"分割时成功出现两对键值对


![[file-20251212232639537.png]]
...
![[file-20251212232639533.png]]

**执行成功**

![[file-20251212232639530.png]]
...
![[file-20251212232639523.png]]

2. 在docker中用pear命令下载
 

![[file-20251212232639522.png]]

看到已经下载下来了，保存在/tmp/pear/download/1.txt

![[file-20251212232639516.png]]
...
![[file-20251212232639283.png]]

执行成功，但是没有写入权限

# peclcmd.php
当pearcmd被ban了的时候可以用它来代替，看一下源代码
```php
<?php
/**
