> 关联：[[../PHP安全总览|PHP安全总览]]、[[绕过wakeup]]、[[绕过O：]]、[[phar的文件包含与反序列化]]

# 魔术方法

![[file-20251216150512685.png]]
...
主要利用的就是php格式读session时会把`|`后的内容反序列化，所以我们把要利用的序列化字符串加上`|`后传入session中（serialize格式）,就会被反序列化

# phar反序列化

使用条件

![[file-20251216150602394.png]]
...
![[file-20251216150609584.png]]

要这样

![[file-20251216150721958.png]]
