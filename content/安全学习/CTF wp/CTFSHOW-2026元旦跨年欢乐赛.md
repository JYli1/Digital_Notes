...
![[file-20260106191357781.png]]
然后16进制转字符即可
![[file-20260106191448465.png]]
## Happy2026
...
![[../../CTF刷题记录/assets/Day 10/file-20260103120030681.png]]
...
但是我们直接传入数组是不行的，要注意http中怎么传入数组的：
```http
...
![[file-20260106211347954.png]]
查看前端源码知道，csrf令牌是固定的
![[file-20260106211447691.png]]
