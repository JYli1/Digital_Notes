...
那我们就抓包看看：
![](assets/HXCTF2026（初赛）web部分题解/file-20260529162517612.png)
其实细心观察就会发现有一个自定义的响应头了，回显了我们的ip，那我们就应该想到：服务器是怎么获取我们的ip的呢？
我们试试添加
```http
X-Forwarded-For: 127.0.0.1
```
![](assets/HXCTF2026（初赛）web部分题解/file-20260529162517620.png)
...
```
我们插入`'`试试能不能造成报错。
![](assets/HXCTF2026（初赛）web部分题解/file-20260529162517605.png)
注入点确认。
## 开始注入
...
```
![](assets/HXCTF2026（初赛）web部分题解/file-20260529162517592.png)
并没有产生报错，奇怪了。难道是被waf了？
再试试，updatexml。
![](assets/HXCTF2026（初赛）web部分题解/file-20260529162517599.png)
估计是被ban了，只要出现关键字就直接return掉。
这时候我们就要试试floor了。
![](assets/HXCTF2026（初赛）web部分题解/file-20260529162517585.png)
...
![](assets/HXCTF2026（初赛）web部分题解/file-20260529162517575.png)
