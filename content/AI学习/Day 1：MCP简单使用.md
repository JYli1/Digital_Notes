> 关联：[[index|AI学习]]、[[Day 2：搭建一个简单的Agent]]、[[Day 6 实现了一个简单的命令执行agent]]
...
首先下载vscode的cline插件：
![[assets/Day 1：MCP简单使用/file-20260109162536060.png]]
...
1. 先注册
2. 然后点这里
![[assets/Day 1：MCP简单使用/file-20260109162536059.png]]
3. 然后点Creat，会出现这个（这里name随便填，下面这个是最多一次用多少余额，不太要管，也可以设置一个5吧，最下面两个就默认就好了）
![[assets/Day 1：MCP简单使用/file-20260109162536057.png]]
...
![[assets/Day 1：MCP简单使用/file-20260109162536002.png]]
看到同样是读取到了的。然后我们看看clien中是否正常使用了
![[assets/Day 1：MCP简单使用/file-20260109162535992.png]]
![[assets/Day 1：MCP简单使用/file-20260109162534957.png]]
可以看到，他是正常使用了，我这里让它还帮我整理了文件，最后完成的还不错，但是有一些剩余的文件可能编码问题没处理好，可能换付费的模型会处理的更好。
