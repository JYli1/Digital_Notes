...
![[assets/Day 8/file-20251226170048410.png]]
### request模块获取任意字符
...
![[assets/Day 8/file-20251226170102736.png]]
可以使用`request.endpoint`获取到当前路由的函数名，即`r3al_ins1de_th0ught`
![[assets/Day 8/file-20251226170150733.png]]
并且这个方法还有可以直接取到字符（下标从0开始）：
![[assets/Day 8/file-20251226170755236.png]]
...
![[assets/Day 8/file-20251226173516118.png]]
看到已经成功获取了
### 绕过删除模块
这里把很多的rce函数给删掉了，
这里也很自然可以想到`方法重载`
...
效果就是：
![[assets/Day 8/file-20251226173854375.png]]
