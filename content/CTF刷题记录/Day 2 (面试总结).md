...
```
得到几乎相同了只有一点细微的差别
![[../安全学习/SQL注入/assets/Quine注入/file-20251217173850996.png]]

最终payload：
```sql
replace(replace('replace(replace(".",char(34),char(39)),char(46),".")',char(34),char(39)),char(46),'replace(replace(".",char(34),char(39)),char(46),".")');
```
![[../安全学习/SQL注入/assets/Quine注入/file-20251217172806694.png]]
看到输入输出完全一样了
...
```
![[../安全学习/PHP安全/assets/filter-chain RCE/file-20251218131840603.png]]
...
![[../安全学习/PHP安全/assets/filter-chain RCE/file-20251218145523921.png]]
...
我们用工具生成pyload：
![[../安全学习/PHP安全/assets/filter-chain RCE/file-20251218153659904.png]]
直接rce了，![[../安全学习/PHP安全/assets/filter-chain RCE/file-20251218153746180.png]]
## 2.5 有效路径
...
![[../安全学习/PHP安全/assets/filter-chain RCE/file-20251218153859847.png]]
...
![[assets/Day 2 (面试总结)/file-20251221215433242.png]]
![[assets/Day 2 (面试总结)/file-20251221215433245.png]]
